    ...
    '/docs/': [
      {
        ...
        children: [
          ...
          'getting-started/run-clusterimage',
          'getting-started/using-clusterfile',
          'getting-started/build-clusterimage',
      ...
      },
      {
        ...
        children: [
          ...
          'advanced/arm-clusterimage',
          'advanced/containerd-baseimage',
          'advanced/define-clusterimage',
          'advanced/develop-plugin',
          'advanced/gpu-clusterimage',
    ...
    '/zh/': [
      {
        ...
        children: [
          ...
          'getting-started/quick-start',
          'getting-started/using-clusterfile',
          'getting-started/use-clusterimage',
          'getting-started/build-clusterimage',
          'getting-started/build-appimage',
          'getting-started/config',
          'getting-started/plugin',

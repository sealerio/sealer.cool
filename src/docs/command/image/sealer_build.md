...
build command is used to generate a ClusterImage from specified Kubefile.
...
```
  ...
  -h, --help                            help for build
      ...
      --label strings                   add labels for image. Format like --label key=[value] (default [io.sealer.version=unknown])
  ...
  -t, --tag string                      specify a name for ClusterImage
